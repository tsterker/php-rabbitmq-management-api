...
class Vhost extends AbstractApi
{
    ...
    {
        return $this->client->send(Helper::uri_template('/api/vhosts/{name}', ['name' => $name]));
    }
    ...
    {
        return $this->client->send(Helper::uri_template('/api/vhosts/{name}', ['name' => $name]), 'PUT');
    }
    ...
    {
        return $this->client->send(Helper::uri_template('/api/vhosts/{name}', ['name' => $name]), 'DELETE');
    }
    ...
    {
        return $this->client->send(Helper::uri_template('/api/vhosts/{name}/permissions', ['name' => $name]));
    }
}
